...
class TestQnnCompilerSpec(unittest.TestCase):
    def test_fcb_pairs_soc_and_htp_options(self):
        ...
        self.assertTrue(option.target_options.fcb_reference_weight_sharing)
        self.assertEqual(
        ...
        self.assertEqual(
            [
                target.backend_options[0].htp_options.precision
    ...
    def test_single_target_remains_non_fcb(self):
        ...
        self.assertIsNone(option.target_options)
        self.assertEqual(
