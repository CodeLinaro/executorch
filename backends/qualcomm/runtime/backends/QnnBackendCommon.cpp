...
Error QnnBackend::VerifyQNNSDKVersion() {
  ...
  } else if (qnn_interface.GetBackendId() == QNN_BACKEND_ID_IR) {
    expected_version.backendApiVersion.major = QNN_IR_API_VERSION_MAJOR;
    expected_version.backendApiVersion.minor = QNN_IR_API_VERSION_MINOR;
    expected_version.backendApiVersion.patch = QNN_IR_API_VERSION_PATCH;
  }
