...
class QnnConfig:
    ...
    def __post_init__(self):
        ...
        if not self.enable_x86_64 and not self.compile_only and self.device is None:
            raise RuntimeError(
                "device serial is required if not compile only. Please specify a device serial."
            )
...
class SimpleADB:
    ...
    def __init__(
        ...
        self.htp_arch = get_soc_to_arch_map()[qnn_config.soc_model]
